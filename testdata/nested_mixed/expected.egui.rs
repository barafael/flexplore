                        ...
                        ui.with_layout(layout, |ui| {
                            egui::Frame::none()
                                ...
                                .show(ui, |ui| {
                                    ...
                                    ui.centered_and_justified(|ui| {
                                        ui.label(egui::RichText::new("X").size(26.0).color(egui::Color32::from_rgba_premultiplied(13, 13, 26, 217)));
                                    });
                                });
                            egui::Frame::none()
                                ...
                                .show(ui, |ui| {
                                    ui.set_min_size(egui::vec2(40.0, 40.0));
                                    ui.centered_and_justified(|ui| {
                                        ui.label(egui::RichText::new("Y").size(26.0).color(egui::Color32::from_rgba_premultiplied(13, 13, 26, 217)));
                                    });
                                });
                        });
