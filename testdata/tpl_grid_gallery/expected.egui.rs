            ...
            egui::Grid::new("gallery")
                ...
                .show(ui, |ui| {
                    ...
                    egui::Frame::none()
                        ...
                        .show(ui, |ui| {
                            ui.centered_and_justified(|ui| {
                                ui.label(egui::RichText::new("img-1").size(26.0).color(egui::Color32::from_rgba_premultiplied(13, 13, 26, 217)));
                            });
                        });
                    egui::Frame::none()
                        ...
                        .show(ui, |ui| {
                            ui.centered_and_justified(|ui| {
                                ui.label(egui::RichText::new("img-2").size(26.0).color(egui::Color32::from_rgba_premultiplied(13, 13, 26, 217)));
                            });
                        });
                    egui::Frame::none()
                    ...
                    egui::Frame::none()
                        ...
                        .show(ui, |ui| {
                            ui.centered_and_justified(|ui| {
                                ui.label(egui::RichText::new("img-3").size(26.0).color(egui::Color32::from_rgba_premultiplied(13, 13, 26, 217)));
                            });
                        });
                    egui::Frame::none()
                        ...
                        .show(ui, |ui| {
                            ui.centered_and_justified(|ui| {
                                ui.label(egui::RichText::new("img-4").size(26.0).color(egui::Color32::from_rgba_premultiplied(13, 13, 26, 217)));
                            });
                        });
                });
