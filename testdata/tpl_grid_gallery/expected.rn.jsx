  ...
  return (
    ...
    <View style={{
      ...
      <View style={{
        ...
        <Text style={{ color: 'rgba(13, 13, 26, 0.85)', fontSize: 26 }}>img-1</Text>
      </View>
      <View style={{
        flexDirection: 'row',
        flexWrap: 'wrap',
        ...
        <Text style={{ color: 'rgba(13, 13, 26, 0.85)', fontSize: 26 }}>img-2</Text>
      </View>
      {/* grid-row: span 2 — not supported in RN */}
      <View style={{
        flexDirection: 'row',
        flexWrap: 'wrap',
        justifyContent: 'center',
        ...
        <Text style={{ color: 'rgba(13, 13, 26, 0.85)', fontSize: 26 }}>tall</Text>
      </View>
      <View style={{
        flexDirection: 'row',
        flexWrap: 'wrap',
        ...
        <Text style={{ color: 'rgba(13, 13, 26, 0.85)', fontSize: 26 }}>img-3</Text>
      </View>
      <View style={{
        flexDirection: 'row',
        flexWrap: 'wrap',
        ...
        <Text style={{ color: 'rgba(13, 13, 26, 0.85)', fontSize: 26 }}>img-4</Text>
      </View>
    </View>
  );
}
