            ...
            egui::Grid::new("dashboard")
                ...
                .show(ui, |ui| {
                    ...
                    egui::Frame::none()
                        ...
                        .show(ui, |ui| {
                            ui.centered_and_justified(|ui| {
                                ui.label(egui::RichText::new("sidebar").size(26.0).color(egui::Color32::from_rgba_premultiplied(13, 13, 26, 217)));
                            });
                        });
                    egui::Frame::none()
                        ...
                        .show(ui, |ui| {
                            ui.centered_and_justified(|ui| {
                                ui.label(egui::RichText::new("main").size(26.0).color(egui::Color32::from_rgba_premultiplied(13, 13, 26, 217)));
                            });
                        });
                    ui.end_row();
                    egui::Frame::none()
