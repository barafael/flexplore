fn spawn_ui(commands: &mut Commands) {
    ...
    commands.spawn((
        Node {
            ...
            grid_template_columns: vec![RepeatedGridTrack::fr(1, 1.0), RepeatedGridTrack::fr(1, 1.0)],
            grid_template_rows: vec![RepeatedGridTrack::px(1, 80.0), RepeatedGridTrack::px(1, 80.0)],
