...
pub fn holy_grail() -> NodeConfig {
    ...
    header.width = ValueConfig::Percent(100.0);
    ...
    middle.width = ValueConfig::Percent(100.0);
    ...
    footer.width = ValueConfig::Percent(100.0);
...
pub fn sidebar_content() -> NodeConfig {
    ...
    sidebar.children = vec![
        NodeConfig::new_leaf("nav-1", 200.0, 40.0),
        NodeConfig::new_leaf("nav-2", 200.0, 40.0),
        NodeConfig::new_leaf("nav-3", 200.0, 40.0),
    ];
    for child in &mut sidebar.children {
        child.width = ValueConfig::Percent(100.0);
    }
...
pub fn nav_bar() -> NodeConfig {
    ...
    links.column_gap = ValueConfig::Px(16.0);
    links.width = ValueConfig::Auto;
    links.height = ValueConfig::Auto;
    links.flex_wrap = FlexWrap::NoWrap;
    links.children = vec![
        NodeConfig::new_leaf("link-1", 80.0, 40.0),
        NodeConfig::new_leaf("link-2", 80.0, 40.0),
        NodeConfig::new_leaf("link-3", 80.0, 40.0),
    ];
    ...
    actions.children = vec![
        NodeConfig::new_leaf("btn-1", 40.0, 40.0),
        NodeConfig::new_leaf("btn-2", 40.0, 40.0),
    ];
