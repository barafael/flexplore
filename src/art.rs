...
pub fn palette_color(palette: ColorPalette, idx: usize) -> (f32, f32, f32) {
    match palette {
        ...
        ColorPalette::Tableau10 => colorous_to_f32(colorous::TABLEAU10[idx % colorous::TABLEAU10.len()]),
        ColorPalette::Category10 => colorous_to_f32(colorous::CATEGORY10[idx % colorous::CATEGORY10.len()]),
